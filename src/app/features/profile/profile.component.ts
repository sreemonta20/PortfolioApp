...
export class ProfileComponent implements OnInit {
  ...
  trackBySkillCat(_: number, item: any) {
    return item.id;
  }
  trackBySkill(_: number, item: any) {
    return item.id;
  }
  trackByExp(_: number, item: any) {
    return item.id;
  }
  trackByEdu(_: number, item: any) {
    return item.id;
  }
  trackByCert(_: number, item: any) {
    return item.id;
  }
}
